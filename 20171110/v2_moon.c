...
int main(void){
    ...
    /* open an output file */
    fp1 = fopen("v2_moon_1.dat","w");
    fp2 = fopen("v2_moon_2.dat","w");
    fp3 = fopen("v2_moon_3.dat","w");
    fp4 = fopen("v2_moon_4.dat","w");
    fp5 = fopen("v2_moon_5.dat","w");
    ...
    dt = 50;
    for(i=0;i<=maxstep;i++){
        RK4_moon(x[4],y[4],vx[4],vy[4],dt,Xm,GMe,GMm,i,maxstep);
        /* ouput the updated values */
        fprintf(fp5,"%16.8e %16.8e\n",x[4][i+1],y[4][i+1]);
    }
